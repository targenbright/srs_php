...
if (isset($_POST["firstName"]) || isset($_POST["lastName"])) :
    ...
    // $spouseQuery = "SELECT AdultID FROM ADULT WHERE Email = '$email' AND PhoneNumber = '$phoneNumber'";
    // echo $spouseQuery;
    ...
    if (empty($firstName) || empty($lastName)) {
        ...
        // Spouse already exists in database. Need to update with new information.
    ...
    <form action="" method="post" name="formSignup" id="formSignup">
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input name="firstName" type="text" class="form-control disabled" id="firstName" value="<?= $row["FirstName"] ?>" readonly="readonly" />
            </div>
            <div class="form-group col-md-6">
